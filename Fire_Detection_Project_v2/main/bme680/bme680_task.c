...
void bme680_task(void *parameter)
{
  ...
  for (;;)
  {
    ...
    bme680_data.temperature = bme680_values.temperature;
    bme680_data.humidity = bme680_values.humidity;
    bme680_data.pressure = bme680_values.pressure;
    bme680_data.gas_resistance = bme680_values.gas_resistance;
    xQueueSend(bme680_queue, &bme680_data, portMAX_DELAY);
